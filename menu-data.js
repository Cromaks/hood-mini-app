window.MENU_DATA = {
  ...
  items: {
    ...
    "Сырники": [
      ...
      {
        name: "Домашние сырники с бананами в карамели",
      ...
      {
        name: "Домашние сырники с манго-кремом",
    ...
    "Панкейки": [
      ...
      {
        name: "Панкейки с тыквой",
        description: "Со взбитыми сливками, пралине, облепиховым гелем, крамблом из печенья с морковью и цветочной посыпкой."
      },
      {
    ...
    "Сэндвичи": [
      ...
      {
        name: "Сэндвич с ветчиной и глазуньей",
